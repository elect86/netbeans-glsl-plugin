...
public class GlslKeywords {
    ...
    private static final String keywordsString6 = ""
            ...
            + "uintBitsToFloat fma frexp ldexp packUnorm2x16 packSnorm2x16 packUnorm4x8 packSnorm4x8 "
            + "unpackUnorm2x16 unpackSnorm2x16 unpackUnorm4x8 unpackSnorm4x8  packDouble2x32 "
            + "unpackDouble2x32 packHalf2x16 unpackHalf2x16 length distance dot cross normalize "
            + "faceforward reflect refract matrixCompMult outerProduct transpose determinant inverse "
            + "lessThan lessThanEqual greaterThan greaterThanEqual equal notEqual any all not uaddCarry "
