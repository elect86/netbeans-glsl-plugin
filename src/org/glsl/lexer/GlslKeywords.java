...
public class GlslKeywords {
    ...
    private static final String keywordsString1 = ""
            ...
            + "uniform "
            + "varying "
            + "volatile restrict readonly writeonly struct layout centroid flat smooth noperspective patch sample break continue do for while switch case default  if else subroutine in out inout true false invariant discard return lowp mediump highp precision";
